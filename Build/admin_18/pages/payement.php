            ...
            <form method="POST" action="?&action=editPayement">
                <div class="col-md-12">
                    ...
                    <div style="<?php if($affichage == "paypal"){ echo 'display: none;';}elseif($affichage == "dedipass"){echo'display: none';}else{echo 'display: block;';}?>">
                        <div class="row">
                            <div class="alert alert-danger">
                                <p>Notre système "PaySafeCard" n'est pas affilié à PaySafe / PaySafeCard LTD et repose sur une validation manuel ! Lorsqu'un joueur achète des jetons via une offre PaySafeCard il faut venir sur cette page afin de récupérer le code du joueur, prélever le montant de l'offre et cliquer sur le bouton de validation afin de livrer les jetons à l'acheteur ! Pour valider des codes paysafecard / verifier le solde de la carte paysafecard rendez-vous <a href="https://www.paysafecard.com/fr-fr/" target="_blank" rel="noopener noreferrer">sur le site officiel de PaySafe</a> </p>
