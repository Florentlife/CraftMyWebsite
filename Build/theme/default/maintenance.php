                ...
                <div class="container text-center">
                    ...
                    <div class="row">
                        <div class="col-sm-3 text-center wow fadeInLeft">
                            <a href="<?php echo $configFile['Pied']['facebook']; ?>" target="about_blank" class="fa-stack fa-2x hvr-grow">
                        ...
                        <div class="col-sm-3 text-center wow fadeInLeft" data-wow-delay="0.3s">
                            <a href="<?php echo $configFile['Pied']['youtube']; ?>" target="about_blank" class="fa-stack fa-2x hvr-grow">
                        ...
                        <div class="col-sm-3 text-center wow fadeInRight" data-wow-delay="0.4s">
                            <a href="<?php echo $configFile['Pied']['discord']; ?>" target="about_blank" class="fa-stack fa-2x hvr-grow">
                        ...
                        <div class="col-sm-3 text-center wow fadeInRight" data-wow-delay="0.7s">
                            <a href="<?php echo $configFile['Pied']['twitter']; ?>" target="about_blank" class="fa-stack fa-2x hvr-grow">
