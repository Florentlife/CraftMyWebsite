<div class="panel panel-default cmw-sidebar-panel">
  <div class="panel-body cmw-sidebar-panel-body">
    ...
    <a href="?page=configsite" class="btn btn-default btn-block cmw-sidebar-btn hvr-bounce-to-right <?php if(isset($pageadmin)&& $pageadmin == 'configsite'){ echo 'active'; } ?>" role="button">Réglage site <i class="fa fa-heartbeat cmw-fa-sidebar" aria-hidden="true"></i></i></a>
    <?php } ?>
    ...
    <a href="?page=grade" class="btn btn-default btn-block cmw-sidebar-btn hvr-bounce-to-right <?php if(isset($pageadmin)&& $pageadmin == 'grade'){ echo 'active'; } ?>" role="button"><strong>Gestion</strong><i class="fa fa-arrow-right" aria-hidden="true"></i></i> Rangs <i class="fa fa-users cmw-fa-sidebar" aria-hidden="true"></i></a>
    <?php } ?>

    <?php if($_Joueur_['rang'] == 1 OR $_PGrades_['PermsPanel']['news']['showPage'] == true) { ?>
    <a href="?page=news" class="btn btn-default btn-block cmw-sidebar-btn hvr-bounce-to-right <?php if(isset($pageadmin)&& $pageadmin == 'news'){ echo 'active'; } ?>" role="button"><strong>Gestion</strong><i class="fa fa-arrow-right" aria-hidden="true"></i></i> News <i class="fa fa-info-circle cmw-fa-sidebar" aria-hidden="true"></i></a>
    <?php } ?>

    <?php if($_Joueur_['rang'] == 1 OR $_PGrades_['PermsPanel']['vote']['showPage'] == true) { ?>
    <a href="?page=voter" class="btn btn-default btn-block cmw-sidebar-btn hvr-bounce-to-right <?php if(isset($pageadmin)&& $pageadmin == 'voter'){ echo 'active'; } ?>" role="button"><strong>Gestion</strong><i class="fa fa-arrow-right" aria-hidden="true"></i></i> Vote <i class="fa fa-star cmw-fa-sidebar" aria-hidden="true"></i></a>
    <?php } ?>
    ...
    <a href="?page=support" class="btn btn-default btn-block cmw-sidebar-btn hvr-bounce-to-right <?php if(isset($pageadmin)&& $pageadmin == 'support'){ echo 'active'; } ?>" role="button"><strong>Gestion</strong><i class="fa fa-arrow-right" aria-hidden="true"></i></i> Support <i class="fa fa-life-ring cmw-fa-sidebar" aria-hidden="true"></i></i></a>
    <?php } ?>

    <?php if($_Joueur_['rang'] == 1 OR $_PGrades_['PermsPanel']['support']['maintenance']['showPage'] == true) { ?>
    <a href="?page=maintenance" class="btn btn-default btn-block cmw-sidebar-btn hvr-bounce-to-right <?php if(isset($pageadmin)&& $pageadmin == 'maintenance'){ echo 'active'; } ?>" role="button"><strong>Gestion</strong><i class="fa fa-arrow-right" aria-hidden="true"></i></i> Maintenance <i class="fa fa-wrench cmw-fa-sidebar" aria-hidden="true"></i></a>
    <?php } ?>
