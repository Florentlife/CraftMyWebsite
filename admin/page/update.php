<div class="cmw-page-content-header"><strong>Gestion</strong> - Gérer les mises à jours</div>
	...
	<div class="col-md-12 text-center">
		<div class="row">
			<div class="alert alert-danger">
				<strong>Votre CMS CraftMyWebsite n'est PAS à jour ! Vous êtes en <?php echo $versioncms; ?> et la dernière version est la <?php echo $versioncmsrelease; ?> !Attention, les mises à jours ne se font pas automatiquement !</strong>
			</div>
		</div>
		<div class="row">
