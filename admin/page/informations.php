          ...
          <div class="col-lg-offset-2 text-center">
            <div class="row">
              <div class="col-lg-10">
                ...
                <div class="row">
                  <textarea style="resize: none;height: 250px" class="form-control" name="msgMail" placeholder="Bienvenue[...] Voici votre lien d'activation..."><?php echo $sysMail[$i]['msgMail']; ?></textarea>
                </div>
                <hr>
                <div class="row">
                  <input type="submit" class="btn btn-info" value="Valider" />
